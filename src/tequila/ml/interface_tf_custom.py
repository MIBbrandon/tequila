...
class TFLayer(tf.keras.layers.Layer):
    def __init__(self, objective: Union[Objective, VectorObjective],
    ...
    def call(self, toIgnore=0, input_tensor: tf.Tensor = None):
        """
    ...
    def _do(self, input_tensor: tf.Tensor = None):
        """
    ...
    def realForward(self, inputs: tf.Tensor, angles: tf.Tensor):
        """
